"""
 * @author: zkyuan
 * @date: 2025/8/19 10:28
 * @description: 拓展-->langchain提示词模块3
    少量示例（FewShotPromptTemplate）
"""
import os
...
message = example_prompt.format(**examples[0]).format("谁的寿命更长，穆罕默德·阿里还是艾伦·图灵？")
...
print(model.invoke(prompt.format(input="乔治·华盛顿的母亲是谁？")))